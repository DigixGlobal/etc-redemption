...
module.exports = function (server) {
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.get.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      ...
      pre: [{ method: resources.object.put.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.stat.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.data.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.links.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      ...
      pre: [{ method: resources.object.patchAppendData.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      ...
      pre: [{ method: resources.object.patchSetData.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.patchAddLink.parseArgs, assign: 'args' }],
  ...
  api.route({
    ...
    config: {
      pre: [{ method: resources.object.patchRmLink.parseArgs, assign: 'args' }],
